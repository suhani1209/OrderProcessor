...
public interface OrderService {
	...
	/*********FETCHING ORDER GIVEN ORDER ID ********INPUT PARAMETER : ORDER ID**/
	public Order getByOrderId(Integer orderId);
	
	/*********ADD ORDER *********INPUT PARAMETER : LIST OF PRODUCTS ORDERED, USER ID(WHICH USER PLACED ORDER*******/
	public void addOrder(List<Product> products,Integer id);
	
	/*********UPDATE ORDER *********INPUT PARAMETER : ORDER ID ******/
	public Order updateOrder(Integer orderId,Order order);
	
	/*********DELETE ORDER *********INPUT PARAMETER : ORDER ID ******/
	public Order deleteOrder(Integer orderId);
	
	/********FETCHING ALL THE ORDERS WHICH A PARTICULAR USER PLACED *********INPUT PARAMETER : USER ID****/
